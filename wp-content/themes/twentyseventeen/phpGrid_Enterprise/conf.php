...
define('PHPGRID_DB_USERNAME', DB_USER);     // database user name
define('PHPGRID_DB_PASSWORD', DB_PASSWORD); // database password
define('PHPGRID_DB_NAME', DB_NAME); // database name
...
define('SERVER_ROOT', get_template_directory_uri() . '/phpGrid_Enterprise');
define('THEME', 'cobalt');
